...
export const metadata = {
  title: "Hockey World Cup 2026 Pool D: Standings & Matches",
  description: "Get the complete Pool D standings and match fixtures for the 2026 FIH Hockey World Cup. Track teams, rankings, results, and expert predictions.",
  alternates: {
  ...
  openGraph: {
    title: "Hockey World Cup 2026 Pool D: Standings & Matches",
    description: "Get the complete Pool D standings and match fixtures for the 2026 FIH Hockey World Cup. Track teams, rankings, results, and expert predictions.",
    url: "https://hockeyworldcup2026schedule.com/pool-d",
    images: [
      {
        url: "/og-image.jpg",
        width: 1200,
        height: 630,
        alt: "Hockey World Cup 2026 Pool D: Standings & Matches",
      },
    ],
  },
  twitter: {
    ...
    <>
      ...
      <section className="hero-section">
        <div className="sports-container hero-content">
          ...
          <h1 className="hero-title">Hockey World Cup 2026 Pool D Standings & Matches</h1>
