    ...
    <>
      ...
      <main className="sports-container py-12">
        ...
        <section className="guidelines-card">
          ...
          <p>
            During the 2026 Men's and Women's tournament, this page will host 50 individual match centres. Each match centre automatically updates with official lineups, starting eleven, team captain selections, and match official identities 60 minutes before the scheduled pushback.
          </p>
          <p>
