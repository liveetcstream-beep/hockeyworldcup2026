...
export const metadata = {
  title: "Pakistan Hockey World Cup 2026: Schedule, Squad & Pool D Fixtures",
  description:
    "Pakistan men's and women's hockey team complete schedule, Pool D fixtures, PST timings, squad list and key players for FIH Hockey World Cup 2026 in Belgium & Netherlands.",
  alternates: {
    canonical: `${BASE}/pakistan-hockey-world-cup-2026`,
  },
  openGraph: {
    title: "Pakistan Hockey World Cup 2026: Schedule, Squad & Pool D Fixtures",
    description:
      "Pakistan men's hockey team Pool D fixtures, PST match timings, squad analysis and key players for FIH Hockey World Cup 2026.",
    url: `${BASE}/pakistan-hockey-world-cup-2026`,
    ...
    <>
      ...
      <section className="hero-section">
        <div className="sports-container hero-content">
          ...
          <h1 className="hero-title">Pakistan at Hockey World Cup 2026</h1>
          <p className="hero-description">
            Complete Pakistan men's hockey fixture guide, PKT match timings, squad analysis and live updates for the FIH Hockey World Cup 2026. Pool D fixtures including the India vs Pakistan derby.
          </p>
        ...
        <section style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-color)", borderRadius: "20px", padding: "2rem" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.8rem" }}>
            {[
              ...
              { href: "/india-hockey-world-cup-2026", label: "🇮🇳 India Page" },
