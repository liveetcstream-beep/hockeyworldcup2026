...
export default function MatchPreviewPage() {
  const faqItems = [
  {
    "q": "What time does India vs England match start in India?",
    "a": "The match starts at 16:00 IST (Indian Standard Time) on August 17, 2026."
  }
];
    ...
    <>
      ...
      <main className="sports-container py-12">
        ...
        <nav aria-label="breadcrumb" style={{ marginBottom: "2rem", fontSize: "0.85rem", color: "var(--text-muted)" }}>
          ...
          <span style={{ color: "var(--text-main)", fontWeight: "600" }}>India vs England Guide</span>
        </nav>
        ...
        <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1.2rem", marginBottom: "4rem" }}>
          {[
            ...
            { icon: "🕒", label: "Start Time", value: "12:30 CET / 16:00 IST" },
        ...
        <section style={{ marginBottom: "3rem", lineHeight: "1.8" }}>
          ...
          <p style={{ color: "var(--text-muted)", marginBottom: "1.2rem" }}>
            India vs England matches are always high-speed, intense battles. England plays a highly structured, defensive tactical game, relying on captain David Ames to run the transition. India, led by Harmanpreet Singh, plays a more fluid, attacking style. With both teams eyeing the top spot in Pool D, this matchup is crucial to avoid the crossover playoff route.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "3rem", lineHeight: "1.8" }}>
          ...
          <p style={{ color: "var(--text-muted)", marginBottom: "1.2rem" }}>
            England and India drew their last two tournament matches (including a thrilling 4-4 at the Commonwealth Games).
          </p>
        </section>
        ...
        <section style={{ background: "rgba(192,0,48,0.03)", border: "1px solid rgba(192,0,48,0.1)", borderRadius: "20px", padding: "2rem", marginBottom: "3rem" }}>
          ...
          <p style={{ color: "var(--text-muted)", fontSize: "0.95rem", lineHeight: "1.8", margin: 0 }}>
            India's defense has sometimes struggled against quick aerial balls, which is a key part of England's tactical build-up. England must maintain discipline and avoid conceding penalty corners to Harmanpreet.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "3rem", lineHeight: "1.8" }}>
          ...
          <ul style={{ color: "var(--text-muted)", paddingLeft: "1.2rem" }}>
            <li><strong>Official Broadcast Networks:</strong> Star Sports & Disney+ Hotstar in India; TNT Sports in the UK; Watch.Hockey internationally.</li>
