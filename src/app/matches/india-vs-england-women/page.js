...
export default function MatchPreviewPage() {
  const faqItems = [
  {
    "q": "What is the start time of the India vs England Women's match?",
    "a": "The match starts at 12:00 CET, which is 15:30 IST (Indian Standard Time)."
  }
];
    ...
    <>
      ...
      <main className="sports-container py-12">
        ...
        <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(200px, 1fr))", gap: "1.2rem", marginBottom: "4rem" }}>
          {[
            { icon: "📅", label: "Date", value: "August 20, 2026" },
            { icon: "🕒", label: "Start Time", value: "12:00 CET / 15:30 IST" },
        ...
        <section style={{ marginBottom: "3rem", lineHeight: "1.8" }}>
          ...
          <p style={{ color: "var(--text-muted)", marginBottom: "1.2rem" }}>
            This is the final group match in Pool D and will likely decide the qualification spots. England plays a highly structured, defensive game under captain Hollie Pearne-Webb. India's speed and midfield play under Salima Tete will look to stretch the English defense. It promises to be a highly tactical and physical match.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "3rem", lineHeight: "1.8" }}>
          ...
          <p style={{ color: "var(--text-muted)", marginBottom: "1.2rem" }}>
            England won their last tournament meeting in a close 1-0 match, but India's recent form makes this highly competitive.
          </p>
        </section>
        ...
        <section style={{ background: "rgba(192,0,48,0.03)", border: "1px solid rgba(192,0,48,0.1)", borderRadius: "20px", padding: "2rem", marginBottom: "3rem" }}>
          ...
          <p style={{ color: "var(--text-muted)", fontSize: "0.95rem", lineHeight: "1.8", margin: 0 }}>
            India must improve circle entry efficiency against a compact English defense. England needs to avoid conceding soft penalty corners to Deepika.
          </p>
        </section>
        ...
        <section style={{ marginBottom: "3rem", lineHeight: "1.8" }}>
          ...
          <ul style={{ color: "var(--text-muted)", paddingLeft: "1.2rem" }}>
            <li><strong>Official Broadcast Networks:</strong> Star Sports & Hotstar in India; TNT Sports in the UK; Watch.Hockey internationally.</li>
