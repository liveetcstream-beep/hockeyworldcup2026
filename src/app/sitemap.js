export default function sitemap() {
  ...
  const pages = [
    ...
    // Tier 2 â€” High-traffic live/schedule pages
    ...
    // Tier 3B â€” High-traffic team/group pages (traffic multipliers)
    ...
    // Tier 4 â€” Utility pages (low priority)
