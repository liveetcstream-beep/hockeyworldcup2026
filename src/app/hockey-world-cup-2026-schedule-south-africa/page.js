...
export default function SouthAfricaHockeyPage() {
  ...
  const menMatches = [
    { date: "Aug 16, 2026", time: "~6:30 PM IST", opponent: "🏴󠁧󠁢󠁷󠁬󠁳󠁿 Wales", pool: "Pool D", venue: "Belfius Arena", type: "Pool Stage" },
    ...
    <>
      ...
      <section className="hero-section">
        <div className="sports-container hero-content">
          <p className="hero-subtitle">🏑 Pool C — Wagener/Belfius</p>
      ...
      <main className="sports-container py-12">
        ...
        <section style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(180px, 1fr))", gap: "1.2rem", marginBottom: "4rem" }}>
          {[
            ...
            { icon: "⚔️", label: "Pool D Rivals", value: "Australia" },
          ].map((stat) => (
            <div
              key={stat.label}
              style={{
        ...
        <section style={{ marginBottom: "4rem" }}>
          <h2 style={{ fontSize: "1.6rem", fontWeight: "800", color: "var(--text-main)", fontStyle: "italic", borderLeft: "4px solid #c00030", paddingLeft: "1rem", marginBottom: "1.5rem" }}>
            🇮🇳 South Africa Men's Schedule — Pool D
          </h2>
