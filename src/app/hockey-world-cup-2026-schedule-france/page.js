    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hockey World Cup 2026 Schedule France: Time Table, Fixtures & PDF",
      },
    ],
  },
  twitter: {
...
export default function FranceHockeyPage() {
  ...
  const menMatches = [
    { date: "August 15, 2026", time: "7:00 PM CET", opponent: "🇧🇪 Belgium", pool: "Pool B", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 17, 2026", time: "12:00 PM CET", opponent: "🇲🇾 Malaysia", pool: "Pool B", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 19, 2026", time: "3:00 PM CET", opponent: "🇩🇪 Germany", pool: "Pool B", venue: "Belfius Hockey Arena", type: "Pool Stage" },
        ...
        <section style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-color)", borderRadius: "20px", padding: "2rem", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.8rem" }}>
            {[
              ...
              { href: "/hockey-live-streaming", label: "📺 Watch in France (Star Sports)" },
