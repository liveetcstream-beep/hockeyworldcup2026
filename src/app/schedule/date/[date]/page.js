  ...
  return (
    <>
      ...
      <main className="sports-container py-12">
        ...
        {/* Matchday Transit & Venue Zip Codes */}
        <section style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-color)", borderRadius: "16px", padding: "1.5rem 2rem", margin: "2rem 0" }}>
          <h3 style={{ color: "var(--text-main)", fontSize: "1.2rem", fontWeight: "800", marginBottom: "0.8rem" }}>
            📍 Official Matchday Venue Addresses & Postal Codes
          </h3>
          <p style={{ color: "var(--text-muted)", fontSize: "0.9rem", lineHeight: "1.7", marginBottom: "1rem" }}>
            All fixtures are held at Wagener Stadium (Nieuwe Kalfjeslaan 21, 1182 AM Amstelveen) and Belfius Arena (Avenue de la Toison d'Or, 1300 Wavre). Check real-time score updates on our <a href="/live-scores">Live Scores Page</a>.
          </p>
