...
export const metadata = {
  ...
  description: "Official 76-match schedule for the 2026 FIH Hockey World Cup in Netherlands & Belgium. Download PDF fixture list, check USA match timings, and convert to IST/PST.",
};
...
export default function SchedulePage() {
  const faqItems = [
    ...
    },
    {
      ...
      answer: "You can download a print-friendly version of the complete 76-match fixture list as a PDF directly from our website. Just use the 'Print & Save PDF Fixtures' button inside our interactive schedule tool above."
    },
    {
      ...
      <section className="hero-section">
        <div className="sports-container hero-content">
          ...
          <p className="hero-description">
            Get the complete, verified 76-match tournament schedule for the Men's and Women's FIH Hockey World Cups in Belgium & Netherlands. Filter by team, track USA time zones (EDT/ET), view group stages, and download the print-friendly PDF guide.
          </p>
          ...
          <div className="eeat-badge-container">
            ...
            <div className="eeat-badge">
              ⚡ Status: <strong>All 76 Fixtures Confirmed</strong>
            </div>
          </div>
        </div>
      </section>
