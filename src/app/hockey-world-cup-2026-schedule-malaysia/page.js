...
export const metadata = {
  title: "Malaysia Hockey World Cup 2026 Schedule: Time & Matches",
  description: "Malaysia Hockey World Cup 2026 Schedule: Pool B fixtures vs Germany (Aug 17), USA (Aug 19) & Argentina (Aug 21). MYT timings, squad & streaming guide.",
  alternates: {
...
export default function MalaysiaHockeyPage() {
  ...
  const menMatches = [
    { date: "August 15, 2026", time: "6:30 PM MYT (12:30 PM CET)", opponent: "🇩🇪 Germany", pool: "Pool B", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 17, 2026", time: "6:00 PM MYT (12:00 PM CET)", opponent: "🇫🇷 France", pool: "Pool B", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 19, 2026", time: "12:30 AM MYT (6:30 PM CET)", opponent: "🇧🇪 Belgium", pool: "Pool B", venue: "Belfius Hockey Arena", type: "Pool Stage" },
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", background: "var(--bg-secondary)", borderRadius: "16px", overflow: "hidden", boxShadow: "0 4px 20px rgba(15,23,42,0.06)" }}>
              <thead>
                <tr style={{ background: "#c00030", color: "white" }}>
                  {["Date", "Time (MYT)", "Opponent", "Stage", "Venue"].map((h) => (
