...
export const metadata = {
  ...
  description: "Complete Hockey World Cup 2026 Schedule for Malaysia. Find the exact match time table, fixture dates, USA/Canada broadcast times, results, and squad list. Download PDF.",
  alternates: {
