...
export const metadata = {
  title: "Hockey World Cup 2026 Pool C: Standings, Fixtures & Predictions",
  description: "Get the complete outlook for Pool C at the 2026 FIH Hockey World Cup. Includes Men's and Women's team standings, live match schedules, and predictions.",
  alternates: {
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hockey World Cup 2026 Pool C: Standings, Fixtures & Predictions",
      },
    ],
  },
  twitter: {
    ...
    <>
      ...
      <section className="hero-section">
        <div className="sports-container hero-content">
          ...
          <h1 className="hero-title">Hockey World Cup 2026 Pool C Analysis</h1>
