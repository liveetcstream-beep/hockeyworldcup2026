...
const authors = [
  {
    emoji: "✍️",
    name: "HWC Editorial Desk",
    role: "Senior Sports Data Analyst & Editorial Lead",
    location: "Brussels & Lahore",
    experience: "10+ Years Field Hockey Coverage",
    credential: "Verified Tournament Database Auditor",
    summary:
      "The HWC 2026 Editorial Desk manages match schedules, pool standings, broadcast rights matrices, and head-to-head records for international field hockey tournaments. Every schedule on this portal is verified against official FIH Tournament Management System (TMS) match sheets to ensure accuracy for fans, journalists, and spectators.",
  ...
  {
    emoji: "📋",
    name: "HWC Technical Research Team",
    role: "Field Hockey Statistics & Squad Auditor",
    location: "Eindhoven & New Delhi",
    experience: "8+ Years Sports Analytics",
    credential: "FIH TMS Data Verification",
    summary:
      "The Technical Research Team audits every player profile, penalty corner conversion rate, cap tally, and goal record published on this portal. By cross-referencing national hockey federation releases with FIH data feeds, we ensure match records reflect verified pitch statistics.",
