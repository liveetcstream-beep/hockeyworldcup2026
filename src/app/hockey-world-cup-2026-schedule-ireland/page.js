...
export const metadata = {
  title: "Hockey World Cup 2026 Schedule Ireland: Fixtures, Timings & Squad",
  description: "Hockey World Cup 2026 Schedule Ireland: Green Machine Men's Pool C vs Australia (Aug 16), South Africa (Aug 18) & Spain (Aug 20) and Green Army Women's Pool C fixtures. IST/BST timings & squad.",
  alternates: {
    canonical: `${BASE}/hockey-world-cup-2026-schedule-ireland`,
  },
  openGraph: {
    title: "Hockey World Cup 2026 Schedule Ireland: Fixtures, Timings & Squad",
    description: "Hockey World Cup 2026 Schedule Ireland: Pool C fixtures vs South Africa (Aug 15), Spain (Aug 19) & Chile (Aug 20). IST/local timings & squad details.",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hockey World Cup 2026 Schedule Ireland: Time Table, Fixtures & PDF",
      },
    ],
  },
  twitter: {
...
export default function IrelandHockeyPage() {
  ...
  const menMatches = [
    { date: "August 16, 2026", time: "8:30 AM BST (9:30 AM CET)", opponent: "🇦🇺 Australia", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 18, 2026", time: "2:00 PM BST (3:00 PM CET)", opponent: "🇿🇦 South Africa", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 20, 2026", time: "2:00 PM BST (3:00 PM CET)", opponent: "🇪🇸 Spain", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
  ...
  const womenMatches = [
    { date: "August 16, 2026", time: "5:30 PM BST (6:30 PM CET)", opponent: "🇪🇸 Spain", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 18, 2026", time: "8:00 AM BST (9:00 AM CET)", opponent: "🇳🇿 New Zealand", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 20, 2026", time: "5:30 PM BST (6:30 PM CET)", opponent: "🇧🇪 Belgium", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
      ...
      <main className="sports-container py-12">
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", background: "var(--bg-secondary)", borderRadius: "16px", overflow: "hidden", boxShadow: "0 4px 20px rgba(15,23,42,0.06)" }}>
              <thead>
                <tr style={{ background: "#c00030", color: "white" }}>
                  {["Date", "Time (IST/BST)", "Opponent", "Stage", "Venue"].map((h) => (
        ...
        <section style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-color)", borderRadius: "20px", padding: "2rem", marginBottom: "2rem" }}>
          ...
          <div style={{ display: "flex", flexWrap: "wrap", gap: "0.8rem" }}>
            {[
              ...
              { href: "/hockey-live-streaming", label: "📺 Watch in Ireland (Star Sports)" },
        ...
        <section style={{ background: "var(--bg-secondary)", border: "1px solid var(--border-color)", borderRadius: "16px", padding: "1.5rem 2rem", margin: "2rem 0" }}>
          <h3 style={{ color: "var(--text-main)", fontSize: "1.2rem", fontWeight: "800", marginBottom: "1rem" }}>
            📺 Official Broadcast Rights & Venue Postal Codes — Ireland
          </h3>
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: "1.5rem", fontSize: "0.9rem", color: "var(--text-muted)" }}>
            <div>
              <strong>📺 Broadcast Channel:</strong> RTE Player & Premier Sports
            </div>
            <div>
              <strong>⏰ Local Timezone:</strong> IST / BST (Irish Standard Time)
            </div>
            <div>
