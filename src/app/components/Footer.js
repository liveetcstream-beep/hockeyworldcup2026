      ...
      <div className="sports-container">
        <div className="footer-grid" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "2.5rem", marginBottom: "3rem" }}>
          ...
          <div className="footer-col">
            <div className="text-white font-bold" style={{ color: "#fff", fontSize: "1.1rem", fontWeight: "800", marginBottom: "1rem" }}>About Us</div>
            <p style={{ fontSize: "0.85rem", color: "var(--text-muted)", lineHeight: "1.6", marginBottom: "1rem" }}>
              Independent news &amp; live scores portal for the FIH Hockey World Cup 2026.
            </p>
            <p style={{ fontSize: "0.82rem", color: "var(--text-muted)" }}>
              Contact: <a href="mailto:editor@hockeyworldcup2026schedule.com" style={{ color: "var(--text-main)", fontWeight: "600", textDecoration: "none" }}>editor@hockeyworldcup2026schedule.com</a>
            </p>
          </div>
        ...
        <div className="footer-bottom" style={{ borderTop: "1px solid var(--border-color)", paddingTop: "1.5rem", display: "flex", flexWrap: "wrap", justifyContent: "space-between", alignItems: "center", gap: "1rem", fontSize: "0.82rem", color: "var(--text-muted)" }}>
          <p style={{ margin: 0 }}>
            © 2026 HockeyWorldCup2026Schedule.com. All rights reserved.
          </p>
