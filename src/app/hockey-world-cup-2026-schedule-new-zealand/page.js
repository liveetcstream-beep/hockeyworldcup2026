...
export const metadata = {
  title: "New Zealand Hockey World Cup 2026 Schedule: Time & Matches",
...
export default function NewZealandHockeyPage() {
  ...
  const menMatches = [
    { date: "August 16, 2026", time: "12:00 AM NZST (2:00 PM CET)", opponent: "🇳🇱 Netherlands", pool: "Pool A", venue: "Wagener Hockey Stadium", type: "Pool Stage" },
    { date: "August 18, 2026", time: "5:30 PM NZST (7:30 AM CET)", opponent: "🏳️ Japan", pool: "Pool A", venue: "Wagener Hockey Stadium", type: "Pool Stage" },
    { date: "August 20, 2026", time: "8:30 PM NZST (10:30 AM CET)", opponent: "🇦🇷 Argentina", pool: "Pool A", venue: "Wagener Hockey Stadium", type: "Pool Stage" },
  ...
  const womenMatches = [
    { date: "August 16, 2026", time: "1:30 AM NZST (3:30 PM CET)", opponent: "🇧🇪 Belgium", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 18, 2026", time: "7:00 PM NZST (9:00 AM CET)", opponent: "🇮🇪 Ireland", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
    { date: "August 20, 2026", time: "10:00 PM NZST (12:00 PM CET)", opponent: "🇪🇸 Spain", pool: "Pool C", venue: "Belfius Hockey Arena", type: "Pool Stage" },
            ...
            <table style={{ width: "100%", borderCollapse: "collapse", background: "var(--bg-secondary)", borderRadius: "16px", overflow: "hidden", boxShadow: "0 4px 20px rgba(15,23,42,0.06)" }}>
              <thead>
                <tr style={{ background: "#c00030", color: "white" }}>
                  {["Date", "Time (NZST)", "Opponent", "Stage", "Venue"].map((h) => (
