...
export const metadata = {
  title: "Hockey World Cup 2026 H2H: India vs Pakistan Stats",
    ...
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Hockey World Cup 2026 H2H: India vs Pakistan Stats",
      },
    ],
  },
  twitter: {
    ...
    <>
      ...
      <section className="hero-section">
        <div className="sports-container hero-content">
          ...
          <h1 className="hero-title">Hockey World Cup 2026 H2H: India vs Pakistan Stats</h1>
